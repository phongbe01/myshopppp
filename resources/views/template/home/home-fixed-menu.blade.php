                            ...
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item dropdown submenu active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="home-carousel.blade.php">Home Carousel</a></li>
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="home-fixed-menu.blade.php">Home Fixed</a></li>
                                    </ul>
                                </li>
