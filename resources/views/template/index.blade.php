            ...
            <div class="container">
                <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
                    <ul>
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('img/home-slider/slider-1.jpg')}}"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                            ...
                            <div class="slider_text_box">
                                ...
                                style="z-index: 8;font-family: Montserrat,sans-serif;font-weight:700;color:#29263a;"><img src="{{asset('img/home-slider/2017-text.png')}}" alt=""></div>
                        ...
                        <!-- LAYERS -->
                            ...
                            <div class="slider_text_box">
                                ...
                                data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:0px;s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]"
                                data-textAlign="['left','left','left','left','left','center']"
                                style="z-index: 8;font-family: Montserrat,sans-serif;font-weight:700;color:#29263a;"><img src="{{asset('image/home-slider/2017-text.png')}}" alt=""></div>
                ...
                <div class="row feature_inner">
                    <div class="col-lg-5">
                        <div class="f_add_item">
                            <div class="f_add_img"><img class="img-fluid" src="{{asset('img/feature-add/f-add-1.jpg')}}" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="f_add_item right_dir">
                            <div class="f_add_img"><img class="img-fluid" src="{{asset('img/feature-add/f-add-2.jpg')}}" alt=""></div>
                            <div class="f_add_hover">
                                <h4>Best Summer <br />Collection</h4>
                                <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="f_add_item">
                            <div class="f_add_img"><img class="img-fluid" src="{{asset('img/feature-add/f-add-3.jpg')}}" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="l_product_slider owl-carousel">
                    <div class="item">
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="{{asset('img/product/l-product-1.jpg')}}" alt="">
                            </div>
                            <div class="l_p_text">
                                <ul>
                        ...
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="{{asset('img/product/l-product-5.jpg')}}" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                    ...
                    <div class="item">
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="{{asset('img/product/l-product-2.jpg')}}" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="{{asset('img/product/l-product-6.jpg')}}" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                    ...
                    <div class="item">
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="{{asset('img/product/l-product-3.jpg')}}" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="{{asset('img/product/l-product-7.jpg')}}" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                    ...
                    <div class="item">
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="{{asset('img/product/l-product-4.jpg')}}" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                        ...
                        <div class="l_product_item">
                            <div class="l_p_img">
                                <img src="{{asset('img/product/l-product-8.jpg')}}" alt="">
                            </div>
                            <div class="l_p_text">
                               <ul>
                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="f_add_item white_add">
                            <div class="f_add_img"><img class="img-fluid" src="{{asset('img/feature-add/f-add-4.jpg')}}" alt=""></div>
                            <div class="f_add_hover">
                                <h4>Best Summer <br />Collection</h4>
                                <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="f_add_item white_add">
                            <div class="f_add_img"><img class="img-fluid" src="{{asset('img/feature-add/f-add-5.jpg')}}" alt=""></div>
                            <div class="f_add_hover">
                                <h4>Best Summer <br />Collection</h4>
                                <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                            </div>
