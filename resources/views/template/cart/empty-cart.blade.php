                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="checkout.blade.php">Checkout Method</a></li>
                                ...
                                <li class="nav-item dropdown submenu active">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="../categories/categories-no-sidebar-2column.blade.php">Prodcut No Sidebar</a></li>
                                        <li class="nav-item"><a class="nav-link" href="../categories/categories-no-sidebar-3column.blade.php">Prodcut Two Column</a></li>
                                        <li class="nav-item"><a class="nav-link" href="../categories/categories-no-sidebar-4column.blade.php">Product Grid</a></li>
                                        <li class="nav-item"><a class="nav-link" href="../categories/categories-left-sidebar.blade.php">Categories Left Sidebar</a></li>
                                        <li class="nav-item"><a class="nav-link" href="../categories/categories-right-sidebar.blade.php">Categories Right Sidebar</a></li>
                                        <li class="nav-item"><a class="nav-link" href="../categories/categories-grid-left-sidebar.blade.php">Categories Grid Sidebar</a></li>
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="shopping-cart.blade.php">Shopping Cart 01</a></li>
                                        <li class="nav-item"><a class="nav-link" href="shopping-cart2.blade.php">Shopping Cart 02</a></li>
                                        <li class="nav-item"><a class="nav-link" href="empty-cart.blade.php">Empty Cart</a></li>
                                    </ul>
                                </li>
